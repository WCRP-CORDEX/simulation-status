...
They are generated from the CSV file [CMIP6_downscaling_plans.csv](https://github.com/WCRP-CORDEX/simulation-status/blob/main/CMIP6_downscaling_plans.csv), which collects the plans and status reported from the different groups.
...
CORDEX-CMIP6 data are not yet available on ESGF, but a preliminary collection of public servers offering some of these data is available [here](CORDEX_CMIP6_data_servers.html).
